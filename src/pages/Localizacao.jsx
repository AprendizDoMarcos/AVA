...
function Localizacao(){
    ...
    return(
        <section className="w-[90%] mx-auto flex flex-col sm:flex-row items-center shadow-lg shadow-gray-400 hover:shadow-gray-600 transition-all duration-300 rounded-lg h-max py-20 p-5 justify-around border-t-15 border-orange-600 sm:mt-15 mt-7 s:mb-0">
            ...
            <div className="w-[90%] sm:w-[45%] flex justify-center items-center">
